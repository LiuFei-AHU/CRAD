...
class Stem(nn.Module):
    def __init__(self, in_channels):
        ...
        self.features = nn.Sequential(
            Conv3d(in_channels, 32, 3, stride=2, padding=0, bias=False),
            Conv3d(32, 32, 3, stride=1, padding=0, bias=False),
            Conv3d(32, 64, 3, stride=1, padding=1, bias=False),
            nn.MaxPool3d(3, stride=2, padding=0),
            Conv3d(64, 80, 1, stride=1, padding=0, bias=False),
            Conv3d(80, 192, 3, stride=1, padding=0, bias=False),
            nn.MaxPool3d(3, stride=2, padding=0),
        )
...
class DBN(nn.Module):
    def __init__(self, in_channels=1, output_dim=88, k=256, l=256, m=384, n=384, mode=0, **kwargs):
